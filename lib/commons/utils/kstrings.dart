class AppText {
  ...
  static const String kAppName = 'Grabber';
  ...
  static const String kWelcomeHeader =
      'Shop for your favourite groceries with just a \n tap. Find everthing you need, \n just like instore';
  static const String kWelcomeMessage =
      "Designed to help users receive heathcare services with ease. From lab test, getting medicines, doctor appointments and Keeping medical records all can be done from home.";
       static const String kOnboardWishList =
      'Pay online using your cards and unlock \n exclusive Nexus Offer, shop and save \n with ease';
       static const String kOnboardWishListMessage =
      "Your Next Level Medicare Experience Awaits!";
